...
def process_data():
    ...
    with open(enums.NEW_DATA_PATH, 'w',
        ...
        for time in insulin_data.temporal.x_axis:
            ...
            # if time in insulin_data.insulin:
            #     if time in insulin_data.bolus_insulin:
            #         if time in insulin_data.basal_insulin:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, insulin_data.insulin[time], insulin_data.bolus_insulin[time],
            #                                  insulin_data.basal_insulin[time], cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow([time, insulin_data.insulin[time], insulin_data.bolus_insulin[time],
            #                                  insulin_data.basal_insulin[time], ''])
            #         else:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, insulin_data.insulin[time], insulin_data.bolus_insulin[time], '',
            #                                  cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow(
            #                     [time, insulin_data.insulin[time], insulin_data.bolus_insulin[time], '', ''])
            #     else:
            #         if time in insulin_data.basal_insulin:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, insulin_data.insulin[time], '', insulin_data.basal_insulin[time],
            #                                  cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow(
            #                     [time, insulin_data.insulin[time], '', insulin_data.basal_insulin[time], ''])
            #         else:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, insulin_data.insulin[time], '', '', cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow([time, insulin_data.insulin[time], '', '', ''])
            # else:
            #     if time in insulin_data.bolus_insulin:
            #         if time in insulin_data.basal_insulin:
            #             if time in cgm_data.cgm:
            #                 writer.writerow(
            #                     [time, '', insulin_data.bolus_insulin[time], insulin_data.basal_insulin[time],
            #                      cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow(
            #                     [time, '', insulin_data.bolus_insulin[time], insulin_data.basal_insulin[time], ''])
            #         else:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, '', insulin_data.bolus_insulin[time], '', cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow([time, '', insulin_data.bolus_insulin[time], '', ''])
            #     else:
            #         if time in insulin_data.basal_insulin:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, '', '', insulin_data.basal_insulin[time], cgm_data.cgm[time]])
            #             else:
            #                 writer.writerow([time, '', '', insulin_data.basal_insulin[time], ''])
            #         else:
            #             if time in cgm_data.cgm:
            #                 writer.writerow([time, '', '', '', cgm_data.cgm[time]])
            #             else:
